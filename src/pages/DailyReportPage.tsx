...
export function DailyReportPage() {
  ...
  return <section id="daily-report" className="page-section">
    ...
    <div className="report-grid">
      ...
      <article className="panel report-card"><span className="report-index">03</span><h3>今天建议做什么</h3><ol><li>处理高优先级库存异常，确认补货或限售安排。</li><li>查看转化异常的 SKU 与渠道明细。</li><li>复核失败采集任务后再导出经营报表。</li></ol></article>
    </div>
  </section>;
}
