...
export function OverviewPage() {
  ...
  const savedHours = calculateSavedHours(186, 8);
  return <section id="overview">
    ...
    <article className="panel automation-summary"><div className="panel-header"><div><h3>自动化运行摘要</h3><p>运行稳定性与模拟 ROI 单独呈现，不与经营 KPI 混合。</p></div></div><div className="automation-metrics"><div><b>98.9%</b><span>采集任务成功率</span></div><div><b>1</b><span>失败任务快照</span></div><div><b>{savedHours.toFixed(1)} h</b><span>累计节省工时（模拟测算）</span></div></div></article>
  </section>;
}
