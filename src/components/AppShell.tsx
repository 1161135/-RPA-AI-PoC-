  ...
  return <div className="app-shell">
    <aside className="sidebar" aria-label="主导航">
      ...
      <nav className="nav-list">
        ...
        <a className="nav-item nav-divider" href="#order-service-workbench">▤　订单与售后工作台</a><a className="nav-item" href="#order-service-rules">⌘　订单与售后规则</a>
        <a className="nav-item nav-divider" href="#creative-command-center">✦　素材合规指挥台</a><a className="nav-item" href="#creative-review">◇　素材审核工作台</a><a className="nav-item" href="#creative-rules">⌘　素材合规规则</a>
